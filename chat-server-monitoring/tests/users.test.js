...
test('Display Users page', () => {
    ...
    expect(container.textContent).toMatch('Active users2On servers :http://127.0.0.1:7419/unittestUsersServerUser IDUsernameStatus151.11.52.681LouACTIVE172.82.64.792Marc-AntoineACTIVE')
});
